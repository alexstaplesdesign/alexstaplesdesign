...
**[Data Validator App](https://github.com/alexstaplesdesign/data-validator-app)** — FastAPI web app with a dashboard and REST API for validating and processing CSV data files. Python backend, Jinja2 templating, 22 tests.

**[Batch File Processor](https://github.com/alexstaplesdesign/batch-file-processor)** — Java 17 CLI tool that validates and transforms records from CSV input. Maven project with a layered package structure (cli / config / io / model / processing / util) and 22 tests across 5 test classes.
